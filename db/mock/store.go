...
// Source: github.com/1shubham7/bank/db/sqlc (interfaces: Store)
...
// TransferTransection mocks base method.
func (m *MockStore) TransferTransection(arg0 context.Context, arg1 db.TransferTransectionParams) (db.TransferTransectionResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTransection", arg0, arg1)
	ret0, _ := ret[0].(db.TransferTransectionResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TransferTransection indicates an expected call of TransferTransection.
func (mr *MockStoreMockRecorder) TransferTransection(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransferTransection", reflect.TypeOf((*MockStore)(nil).TransferTransection), arg0, arg1)
}
